<%-- 
    Document   : profile
    Created on : Jul 11, 2024, 3:33:31 PM
    Author     : HP
--%>
                        ...
                        <span class="badge">
                            <c:choose>
                                <c:when test="${not empty sessionScope.order.items}">
                                    ${fn:length(sessionScope.order.items)}
                                </c:when>
                                <c:otherwise>
                                    0
                                </c:otherwise>
        ...
        <div class="container mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p><img src="${user.user_image}" alt="User Image" class="img-thumbnail" width="150"></p>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal">Change Information</button>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <form id="editForm" action="profile" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input readonly type="text" class="form-control" name="user_name" value="${user.user_name}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user_image" value="${user.user_image}">
                            </div>
