<%-- 
    Document   : blogpost
    Created on : May 26, 2024, 7:52:42 PM
    Author     : Nguyen Bao
--%>
...
<html>
    ...
    <body>
                ...
                <div class="col-lg-2 d-none d-lg-block">
                    ...
                    <nav
                        ...
                        <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                            <a href="lstblogtype" class="nav-item nav-link">Latest News</a>
                            <c:forEach items="${lstBlogType}" var="o">
                                <a href="navigator?id=${o.getTypeID()}" class="nav-item nav-link">${o.getTypeName()}</a>
                            </c:forEach>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row-sider">
                        ...
                        <div class="col-10">
                            ...
                            <div class="news-detail-head">
                                ...
                                <a href="detailblog?nid=${newsup.id}">
                                    <img class="img-fluid" src="${newsup.getImg()}" alt="Hot News Image">
                                </a>
                                <h2><a href="detailblog?nid=${newsup.id}">${newsup.getTitle()}</a></h2>
                            </div>
                        </div> 
                        <!-- Sider -->
                        <div class="col-3">
                            <h2>Products</h2>
                            <c:forEach items="${newsproduct}" var="o">
                                <div class="news-sider">
                                    <a href="detail?code=${o.id}"><img class="img-fluid" src="${o.getImage()}" alt="Category Image"></a>
                                    <h5><a href="detail?code=${o.id}">${o.getName()}</a></h5>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
        ...
        <div class="container" style="padding-left: 20px; padding-right: 20px;">
            <div class="row">
                <div class="col-md-12">
                    <c:forEach items="${newsdown}" var="o" varStatus="loop">
                        <div class="news-content row">
                            <div class="news-image col-4">
                                <a href="detailblog?nid=${o.id}">
                                    <img src="${o.img}" alt="News Image" class="img-fluid">
                                </a>
                            </div>
                            <div class="news-details col-8">
                                <h2><a href="detailblog?nid=${o.id}" style="color: black;">${o.title}</a></h2>
                                <p>${o.description}</p>
                                <p style="text-align: right; color: rgba(0, 0, 0, 0.5); margin-top: 10px;">${o.date}</p>
                            </div>
                        </div>
                        <!-- Add a horizontal line between news items -->
                        ...
                        <ul class="pagination justify-content-center">
                            <c:forEach begin="1" end="${pagenum}" var="i">
                                <li class="page-item ${page == i ? 'active' : ''}">
                                    <a class="page-link" href="lstblogtype?id=${i}">${i}</a>
                                </li>
                            </c:forEach>
                        </ul>
                    </nav>
