...
private static final Logger LOGGER = Logger.getLogger(MyOrderDetailController.class.getName());
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (orderList != null) {
            LOGGER.info("OrderList details: " + orderList.toString());
        } else {
            LOGGER.warning("OrderList is null for orderId: " + orderID);
        }
