...
public class BlogListManage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<BlogStatus> bs = bl.getAllBlogListPagedDashboard(index);
            ArrayList<BlogPostType> bpt = bl.getBlogType();
            ArrayList<User> author = bl.listAllAuthorBlog();
            int pagenum = bl.getBlogNumInDashBoard();
            ...
            Logger.getLogger(BlogListManage.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
