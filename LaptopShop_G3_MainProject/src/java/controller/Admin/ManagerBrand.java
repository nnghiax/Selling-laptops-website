...
public class ManagerBrand extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // List brand && search brand by name
        String nameB = request.getParameter("name");
        ArrayList<Brand> listBrand ;
        if(nameB != null && !nameB.isEmpty()){
            listBrand = db.searchBrandName(nameB);
        }else{
            listBrand = db.getListBrand();
        }        
        ...
        request.getRequestDispatcher("manaBrand.jsp").forward(request, response);
    } 
